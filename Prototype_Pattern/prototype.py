...
class Prototype:
    ...
    def register(self, identifier, obj):
        """ Register cloned object in dictionary"""
        self.objects[identifier] = obj

    def unregister(self, identifier):
        """ Delete cloned object from dictionary"""
...
def main():
    ...
    site1 = Website('Prototypecreation', 
            domain='prototypecreation.com', 
    ...
    site2 = prototype.clone(identifier,
            name='ProtytpecreationPlayground',
            domain='play.prototypecreation.com', 
